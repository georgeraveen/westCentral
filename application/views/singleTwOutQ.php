...
<html>
    ...
    <?php
        $singleTown= $_POST["vtown"];
        $ageOut = $_POST["age"];
        $ty=$_POST["ctype"];
    ?>
    <body>
	<div class="container mt-5">
        <h2 class="mt-5">Single Town outstanding report</h2>
    ...
    <div id="reportTableclass">
        ...
        <tr>
            <th colspan="5"><?php
                echo "Outstanding for ".$singleTown;
                ?>
            </th>
        </tr>
        <?php
            $totalreport=0;
            $cust = $this->db->query("select * from customer where town = $singleTown and type='$ty' order by custName");
